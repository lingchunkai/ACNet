...
identifier = 'goog_fb_stocks_frank'
ex = Experiment('goog_fb_stocks_frank')
...
if __name__ == '__main__':
    print('Sample usage: python -m train_scripts.stocks.train_with_frank -F learn_stocks_with_frank')
